...
namespace Rainbow.Framework.Providers.RainbowMembershipProvider {
    ...
    public class RainbowUser : MembershipUser, IIdentity {
        ...
        public RainbowUser( string providerName, string name, Guid providerUserKey, string email, string passwordQuestion, string comment, bool isApproved, bool isLockedOut, DateTime creationDate, DateTime lastLoginDate, DateTime lastActivityDate, DateTime lastPasswordChangeDate, DateTime lastLockoutDate )

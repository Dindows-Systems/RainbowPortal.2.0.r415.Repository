...
namespace Rainbow.Framework.Providers.RainbowRoleProvider {
    ...
    public abstract class RainbowRoleProvider : RoleProvider {
        ...
        /// <exception cref="ProviderException">If the throwOnPopulatedRole input parameter is true and the specified role has one 
        /// or more members, DeleteRole throws a ProviderException and does not delete the role.</exception>
        /// <returns></returns>
        ...
        /// <returns><code>true</code> if the update was succeful, or <code>false</code> if the role was not found</returns>
        /// <exception cref="RainbowRoleProviderException">RenameRole throws an exception if there was an unexpected error 
        /// renaming the role.</exception>
        ...
        /// <exception cref="ProviderException">If the role does not exist, FindUsersInRole throws a ProviderException.</exception>
        ...
        /// </summary>
        /// <param name="portalAlias">Rainbow's portal alias</param>
        /// <returns>A list of <code>RainbowRole</code> objects</returns>
        public abstract IList<RainbowRole> GetAllRoles( string portalAlias );
        ...
        /// <exception cref="ProviderException">If the user name does not exist, GetRolesForUser throws a ProviderException.</exception>
        /// <returns>A list of role names.</returns>
        public abstract IList<RainbowRole> GetRolesForUser( string portalAlias, Guid userId );
        ...
        /// <exception cref="ProviderException">If the role does not exist, GetUsersInRole throws a ProviderException.</exception>
        /// <returns>A list of user names.</returns>
        ...
        /// <exception cref="ProviderException">If the user or role does not exist, IsUserInRole throws a ProviderException.</exception>
        /// <returns><code>true</code> if the specified user is associated with the specified role, <code>false</code> otherwise</returns>
        ...
        /// </summary>
        /// <param name="portalAlias">Rainbow's portal alias</param>
        /// <param name="roleIds">A collection of role ids</param>
        /// <param name="userIds">A collection of user ids</param>
        /// <exception cref="ProviderException">RemoveUsersFromRoles throws a ProviderException if any of the users or roles 
        /// do not exist, or if any user specified in the call does not belong to the role from which he or she is being removed.</exception>
        ...
        /// <summary>
        /// Retrieves a <code>RainbowRole</code> given a role name
        /// </summary>
        /// <param name="portalAlias">Rainbow's portal alias</param>

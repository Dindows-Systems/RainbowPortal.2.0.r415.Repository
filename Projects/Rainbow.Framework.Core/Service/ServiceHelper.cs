    ...
    public class ServiceHelper
    {
                                                   ...
                                                   ref ServiceRequestInfo requestInfo)
        {
            ...
            if (requestInfo.ModuleType != "All")
                select.Append(" AND GenModDef.ClassName = 'Rainbow.DesktopModules." + requestInfo.ModuleType + "'");
                                                    ...
                                                    ref ServiceRequestInfo requestInfo)
        {
            ...
            if (moduleType.ToUpper() == "ALL")
                ...
                moduleType = "Rainbow.DLL;Rainbow.DesktopModules." + moduleType;
        ...
        public static bool GetPortalIDViaAlias(string portalAlias, ref int portalID, Page rainbowPage)
        {
            bool portalIDOK = true;

            if (rainbowPage != null)
            {
                portalID = rainbowPage.portalSettings.PortalID;
                return true;
            }
            ...
            //			if (portalAlias.ToLower() == "rainbow")
            //				portalID = 0;  
            //			else
            //			{
            SqlDataReader dr =
        ...
        /// <param name="requestInfo">a filled ServiceRequestInfo class</param>
        /// <param name="rainbowPage">The rainbow page.</param>
        ...
        public static ServiceResponseInfo CallService(int portalID, Guid userID, string applicationFullPath,
                                                      ref ServiceRequestInfo requestInfo, Page rainbowPage)
        {
            ...
            if (requestInfo.Type != ServiceType.RSSService)
            {
                if (portalID < 0)
                {
                    if (!GetPortalIDViaAlias(requestInfo.PortalAlias, ref portalID, rainbowPage))
                ...
                if (requestInfo.LocalMode)
                {
                    if (rainbowPage != null)
                    {
                        responseInfo.ServiceTitle = rainbowPage.portalSettings.PortalName;
                        responseInfo.ServiceLink = Path.ApplicationFullPath;
                        responseInfo.ServiceDescription = rainbowPage.portalSettings.PortalTitle;

                        responseInfo.ServiceImageTitle = rainbowPage.portalSettings.PortalTitle;
                        responseInfo.ServiceImageUrl = Path.ApplicationFullPath + rainbowPage.portalSettings.PortalPath +
                                                       "/logo.gif";
                    ...
                    else
                    {
                        ...
                        responseInfo.ServiceImageUrl = Path.ApplicationFullPath + "_Rainbow/logo.gif"; //JLH!! TBD!
                        responseInfo.ServiceImageLink = Path.ApplicationFullPath;
                    }
                }
            }

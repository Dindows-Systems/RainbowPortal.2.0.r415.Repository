...
//			Controls.AddAt(0, ModuleTitle);
            ...
            LanguageSwitcher1 = new Rainbow.Framework.Web.UI.WebControls.LanguageSwitcher();
            Controls.Add(LanguageSwitcher1);

            // Jes1111
            if (!((Rainbow.Framework.Web.UI.Page) this.Page).IsCssFileRegistered("Mod_LanguageSwitcher"))
                ((Rainbow.Framework.Web.UI.Page) this.Page).RegisterCssFile("Mod_LanguageSwitcher");

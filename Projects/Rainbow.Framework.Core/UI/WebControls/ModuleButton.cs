...
namespace Rainbow.Framework.Web.UI.WebControls
{
	...
	public class ModuleButton : HtmlAnchor
	{
		...
		//			if ( this.PopUp )
		//			{
		//				if ( !((Rainbow.Framework.Web.UI.Page)this.Page).IsClientScriptRegistered("rb-popup") )
		//				((Rainbow.Framework.Web.UI.Page)this.Page).RegisterClientScript("rb-popup",Rainbow.Framework.Settings.Path.ApplicationRoot + "/aspnet_client/popupHelper/popup.js");
		//
		//				if ( !((Rainbow.Framework.Web.UI.Page)this.Page).IsClientPopUpEventListenerRegistered(this.Target) )
		//				{
		//					StringBuilder sb = new StringBuilder();
		...
		//					}
		//					sb.Append(");");
		//					((Rainbow.Framework.Web.UI.Page)this.Page).RegisterClientPopUpEventListener(this.Target, sb.ToString());
		//				}
		//			}
		//			//popup removed until fixed
		//			base.OnPreRender(e);

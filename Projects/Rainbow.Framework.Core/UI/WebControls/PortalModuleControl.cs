...
*/
            ...
            get
            {
                if (helpButton == null && HttpContext.Current != null)
                {
                    ...
                    if (CanHelp)
                    {
                        ...
                        sb.Append(@"/rb_documentation/Viewer.aspx?loc=Rainbow/");
                        sb.Append(aux);
                        sb.Append("&src=");
                        sb.Append(fileName);
        ...
        // Tiptopweb
        // Nicholas Smeaton: custom buttons from module developer enhancement added in Rainbow version 1.4.0.1767a - 03/07/2004
            ...
            get
            {
                if (printButton == null && HttpContext.Current != null)
                {
                    ...
                    if (CanPrint)
                    {
                        ...
                        printButton.Target = "RainbowPrint";

...
Rainbow desktop navigation module - more to download on http://www.rainbowportal.net


INSTALL
1. Run Create_GetTabCrumbs.bat (or execute Create_GetTabCrumbs.sql in SQL Query Analyzer)
2. Copy files DeskTopBreadCrumbs.* files to folder Rainbow\Design\DesktopLayouts and add to project

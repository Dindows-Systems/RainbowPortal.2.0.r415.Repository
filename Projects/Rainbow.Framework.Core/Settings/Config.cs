...
namespace Rainbow.Framework.Settings
{
	...
	public sealed class Config
	{
		...
		/// <br/>
		/// Default value: "rainbow"</summary>
		public static string DefaultPortal
		{
			get { return GetString("DefaultPortal", "rainbow", false).Trim().ToLower(CultureInfo.InvariantCulture); }
		}
		...
		/// <br/>
		/// Default value: "server=localhost;database=Rainbow;uid=sa;pwd="</summary>

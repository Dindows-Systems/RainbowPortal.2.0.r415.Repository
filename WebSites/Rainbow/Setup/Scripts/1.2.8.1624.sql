...
SET @GeneralModDefID = '{2502DB18-B580-4F90-8CB4-C15E6E531031}'
SET @FriendlyName = 'Daily Dilbert'
SET @DesktopSrc = 'DesktopModules/DailyDilbert.ascx'
SET @MobileSrc = ''
SET @AssemblyName = 'Rainbow.DLL'
SET @ClassName = 'Rainbow.Content.Web.ModulesDailyDilbert'
SET @Admin = 0
SET @Searchable = 0

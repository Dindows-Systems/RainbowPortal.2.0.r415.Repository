...
CREATE TABLE [rb_GeneralModuleDefinitions] (
	...
	[AssemblyName] [varchar] (50) NOT NULL CONSTRAINT [DF_rb_GeneralModuleDefinitions_AssemblyName] DEFAULT ('Rainbow.DLL'),
...
Description:
	Contains SQL used to change Rainbow database objects owner from 
...
Assumptions:				
	The script assumes that Rainbow portal is installed with Rainbow AS a database Name.
...
exec rb_Portals_IU 	0	,	N'rainbow'	,	N'Rainbow Portal'	,	N'/_Rainbow'	,	0
GO
...
exec rb_Solutions_IU 	1	,	N'rainbow'
GO

...
EXEC rb_Users_IU 	1	,	0	,	N'Administrator'	,	NULL	,	NULL	,	NULL	,	NULL	,	N'IT'	,	NULL	,	NULL	,	NULL	,	N''	,	NULL	,	N'admin'	,	N'admin@rainbowportal.net'	,	0	,	NULL	,	''
GO
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id(N'[rb_Users_IU]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE [rb_Users_IU]
GO
...
GO
EXEC rb_Modules_IU 	1001, 100, '{72C6F60A-50C4-4F20-8F89-3E8A27820557}', 1, N'ContentPane', N'Rainbow Version', N'Admins', N'Admins;', N'Admins;', N'Admins;', N'Admins;', 0, 0, NULL, 0, 0, NULL, NULL, '', NULL, '', NULL, 0, 0, N'Admins;', N'Admins;'
GO
...
GO
EXEC rb_Modules_IU 	290, 290, '{72C6F60A-50C4-4F20-8F89-3E8A27820557}', 1, N'ContentPane', N'Rainbow Version', N'Admins', N'Admins;', N'Admins;', N'Admins;', N'Admins;', 0, 0, NULL, 0, 0, NULL, NULL, '', NULL, '', NULL, 0, 0, N'Admins;', N'Admins;'
GO
...
SET       DesktopSrc = 'DesktopModules/RoleAssignment/RoleAssignment.ascx',
		  ClassName = 'Rainbow.Content.Web.ModulesRoleAssignment'

...
SET @GeneralModDefID = '{2502DB18-B580-4F90-8CB4-C15E6E531008}'
SET @FriendlyName = 'GoogleSearch'
SET @DesktopSrc = 'DesktopModules/GoogleSearch/GoogleSearch.ascx'
SET @MobileSrc = ''
SET @AssemblyName = 'Rainbow.DLL'
SET @ClassName = 'Rainbow.Content.Web.ModulesGoogleSearch'
SET @Admin = 0
SET @Searchable = 0
...
/* add version info */
INSERT INTO [rb_Versions] ([Release],[Version],[ReleaseDate]) VALUES('1632','1.2.8.1632', CONVERT(datetime, '04/30/2003', 101))
GO

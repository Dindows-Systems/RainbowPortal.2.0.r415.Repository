...
SET @ClassName = 'Rainbow.Content.Web.ModulesRainbowVersion'
SET @Admin = 0
SET @Searchable = 0
...
SET @MobileSrc = ''
SET @AssemblyName = 'Rainbow.DLL'
SET @ClassName = 'Rainbow.Content.Web.ModulesXmlModule'
SET @Admin = 0
SET @Searchable = 0
...
SET @MobileSrc = ''
SET @AssemblyName = 'Rainbow.DLL'
SET @ClassName = 'Rainbow.Content.Web.ModulesXmlLangModule'
SET @Admin = 0
SET @Searchable = 0

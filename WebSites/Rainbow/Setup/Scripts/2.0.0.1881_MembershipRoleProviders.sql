...
create index aspnet_Users_Index2 on [dbo].aspnet_Users(ApplicationId,LastActivityDate)
go
...
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[aspnet_Roles_RenameRole]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'

CREATE PROCEDURE [dbo].[aspnet_Roles_RenameRole]
    @ApplicationName            nvarchar(256),
...
GO
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[aspnet_rbRoles_RenameRole]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'
CREATE PROCEDURE [dbo].[aspnet_rbRoles_RenameRole]
	@RoleId			      UniqueIdentifier,
...
set QUOTED_IDENTIFIER ON
go
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[aspnet_Roles_GetRoleByName]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'
CREATE PROCEDURE [dbo].[aspnet_Roles_GetRoleByName]
    @ApplicationName  nvarchar(256),
    @RoleName         nvarchar(256)
AS
BEGIN
...
INSERT INTO dbo.aspnet_Applications VALUES (N'Rainbow', N'rainbow', N'{CA8DEE6B-0B81-4462-AF3B-6A22B36A0304}', NULL)
GO
--------------------------  PORTALS SETTINGS   ------------------------------------
...
VALUES (N'{CA8DEE6B-0B81-4462-AF3B-6A22B36A0304}', N'{BE7DC028-7238-45D3-AF35-DD3FE4AEFB7E}', N'admin@rainbowportal.net', N'admin@rainbowportal.net', NULL, 0, '2006-04-05 18:12:37.140')
go
...
VALUES (N'{CA8DEE6B-0B81-4462-AF3B-6A22B36A0304}', N'{BE7DC028-7238-45D3-AF35-DD3FE4AEFB7E}', N'admin', 0, N'', NULL, N'admin@rainbowportal.net', N'admin@rainbowportal.net', N'question', N'answer', 1, 0, '2006-03-23 13:46:25.000', '2006-03-23 21:46:58.203', '2006-03-23 13:46:25.000', '1754-01-01 00:00:00.000', 1, '2006-04-05 18:12:37.110', 0, '1754-01-01 00:00:00.000')
go

...
SET @ClassName = 'Rainbow.Content.Web.ModulesContacts'
SET @Admin = 0
SET @Searchable = 1
...
SET @MobileSrc = ''
SET @AssemblyName = 'Rainbow.DLL'
SET @ClassName = 'Rainbow.Content.Web.ModulesBlackList'
SET @Admin = 1
SET @Searchable = 0
...
SET @MobileSrc = ''
SET @AssemblyName = 'Rainbow.DLL'
SET @ClassName = 'Rainbow.Content.Web.ModulesNewsLetter'
SET @Admin = 0
SET @Searchable = 0

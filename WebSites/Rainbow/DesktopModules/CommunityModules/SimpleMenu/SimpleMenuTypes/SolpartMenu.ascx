<%@ control autoeventwireup="false" inherits="Rainbow.Content.Web.Modules.SimpleMenuType"
    language="c#" %>
<!-- START SolpartMenu -->
<rbfwebui:solpartnavigation id="NavigationMenu" runat="server" autobind="False" bind="<%#MenuBindOption%>"
    display="<%#MenuRepeatDirection%>" enableviewstate="False" forcedownlevel="False"
    iconwidth="15" menualignment="Left" menubarheight="22" menubarlefthtml="" menubarrighthtml=""
    ...
    menueffects-mouseoverexpand="True" menuitemheight="22" moveable="False" parenttabid="<%#ParentPageID%>"
    rootarrow="False" selectedbordercolor="transparent" selectedcolor="transparent"
    selectedforecolor="transparent" separatecss="True" shadowcolor="transparent"

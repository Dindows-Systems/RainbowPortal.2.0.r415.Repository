...
DELETE FROM rb_GeneralModuleDefinitions WHERE FriendlyName = 'Lyris (OneFileModule example 2)'
*/
...
SET @GeneralModDefID = NEWID()   -- Or if you want full control: = '{B8784E32-677A-4B8A-87C4-AF108BF12DAC}'
SET @FriendlyName = 'Lyris (OneFileModule example 2)'   -- You enter the module UI name here
SET @DesktopSrc = 'DesktopModules/LyrisExample2.ascx'   -- You enter actual filename here
SET @MobileSrc = ''

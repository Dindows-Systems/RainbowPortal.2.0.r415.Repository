One File Module Example - Lyris example 2
...
INSTALL
1. Copy file LyrisExample2.ascx to folder Rainbow\DesktopModules
   Note: Do not add LyrisExample2.ascx to the project - no compiling needed!
2. Run ApplyDBPatch.bat (or execute DBPatch.sql in SQL Query Analyzer)
3. Log on as Admin and add the "Lyris (OneFileModule example 1)" module to a tabpage 
4. Edit module settings: 
     enter "LyrisListName=aspsmithnews;LyrisServerName=@ls.asplists.com;" in field "Settings string"
5. Use it! ;o) 

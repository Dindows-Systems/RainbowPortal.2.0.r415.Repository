One File Module Example - No Settings
...
INSTALL
1. Copy file NoSettings.ascx to folder Rainbow\DesktopModules
   Note: Do not add NoSettings.ascx to the project - no compiling needed!
2. Run ApplyDBPatch.bat (or execute DBPatch.sql in SQL Query Analyzer)
3. Log on as Admin and add the "No Settings (OneFileModule example 4)" module to a tabpage 
4. Use it! ;o) 

...
DELETE FROM rb_GeneralModuleDefinitions WHERE FriendlyName = 'Simple VB (OneFileModule example 3)'
*/
...
SET @GeneralModDefID = NEWID()   -- Or if you want full control: = '{78684E32-388A-4B8D-87C4-1F108BF12DAC}'
SET @FriendlyName = 'Simple VB (OneFileModule example 3)'  -- You enter the module UI name here
SET @DesktopSrc = 'DesktopModules/SimpleVB.ascx'           -- You enter actual filename here
SET @MobileSrc = ''

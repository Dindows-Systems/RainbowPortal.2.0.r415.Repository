<%@ control autoeventwireup="false" codefile="Tasks.ascx.cs" inherits="Rainbow.Content.Web.Modules.Tasks"
    language="c#" %>
<asp:gridview id="myDataGrid" runat="server" allowpaging="False" allowsorting="True"
    ...
    <columns>
        ...
        <asp:boundfield datafield="DueDate" dataformatstring="{0:d}" headertext="<%$ Resources:Rainbow, TASK_DUEDATE %>"
            sortexpression="DueDate">
            <headerstyle cssclass="NormalBold" />
            <itemstyle cssclass="Normal" />
        </asp:boundfield>
        <asp:templatefield headertext="<%$ Resources:Rainbow, TASK_TITLE %>" sortexpression="Title">
            <headerstyle cssclass="NormalBold" />
            <itemtemplate>
        ...
        <asp:templatefield headertext="<%$ Resources:Rainbow, TASK_STATUS %>" sortexpression="Status">
            <headerstyle cssclass="NormalBold" />
            <itemstyle cssclass="Normal" />
            <itemtemplate>
        ...
        <asp:templatefield headertext="<%$ Resources:Rainbow, TASK_PRIORITY %>" sortexpression="Priority">
            <headerstyle cssclass="NormalBold" />
            <itemstyle cssclass="Normal" />
            <itemtemplate>
        ...
        <asp:boundfield datafield="AssignedTo" headertext="<%$ Resources:Rainbow, TASK_ASSIGNEDTO %>"
            sortexpression="AssignedTo">
            <headerstyle cssclass="NormalBold" />
            <itemstyle cssclass="Normal" />
        </asp:boundfield>
        <asp:templatefield headertext="<%$ Resources:Rainbow, TASK_COMPLETION %>" sortexpression="PercentComplete">
            <headerstyle cssclass="NormalBold" />
            <itemstyle cssclass="Normal" />
            <itemtemplate>
        ...
        <asp:boundfield datafield="ModifiedDate" dataformatstring="{0:d}" headertext="<%$ Resources:Rainbow, DOCUMENT_LAST_UPDATED %>"

<%@ control autoeventwireup="false" codefile="Contacts.ascx.cs" inherits="Rainbow.Content.Web.Modules.Contacts"
    language="c#" %>
<asp:datagrid id="myDataGrid" runat="server" allowsorting="True" autogeneratecolumns="False"
    ...
    <columns>
        <rbfwebui:templatecolumn>
            <itemtemplate>
                <rbfwebui:HyperLink id="HyperLink1" runat="server" imageurl='<%# CurrentTheme.GetImage("Buttons_Edit", "Edit.gif").ImageUrl %>'
                    navigateurl='<%# Rainbow.Framework.HttpUrlBuilder.BuildUrl("~/DesktopModules/CommunityModules/Contacts/ContactsEdit.aspx",PageID,"ItemID=" + DataBinder.Eval(Container.DataItem,"ItemID") + "&mid=" + ModuleID)%>'
                    text="Edit" textkey="EDIT" visible='<%# IsEditable %>'>
                </rbfwebui:HyperLink>
            </itemtemplate>
        </rbfwebui:templatecolumn>
        <rbfwebui:templatecolumn headertext="<%$ Resources:Rainbow, CONTACTS_NAME%>" sortexpression="Name">
        ...
        <rbfwebui:templatecolumn headertext="<%$ Resources:Rainbow, CONTACTS_ROLE%>" sortexpression="Role">
            <itemstyle cssclass="Normal" />
            <itemtemplate>
        ...
        <rbfwebui:templatecolumn headertext="<%$ Resources:Rainbow, CONTACTS_EMAIL%>" sortexpression="Email">
        ...
        <rbfwebui:templatecolumn headertext="<%$ Resources:Rainbow, CONTACTS_CONTACT1%>"
        ...
        <rbfwebui:templatecolumn headertext="<%$ Resources:Rainbow, CONTACTS_CONTACT2%>"
        ...
        <rbfwebui:templatecolumn headertext="<%$ Resources:Rainbow, CONTACTS_FAX%>" sortexpression="Fax">
            <itemstyle cssclass="Normal" wrap="False" />
            <itemtemplate>
        ...
        <rbfwebui:templatecolumn headertext="<%$ Resources:Rainbow, CONTACTS_ADDRESS%>" sortexpression="Address">
            <headerstyle cssclass="NormalBold" />
            <itemstyle cssclass="Normal" />
            <itemtemplate>

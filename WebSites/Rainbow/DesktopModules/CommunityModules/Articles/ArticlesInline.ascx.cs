...
namespace Rainbow.Content.Web.Modules
{
    ...
    public class ArticlesInline : Articles
    {
        ...
        protected Localize TitleDetail;
        protected Localize SubtitleDetail;
        protected Localize StartDateDetail;
        protected Localize Description;
        protected LinkButton goBackBottom;
        protected Localize CreatedLabel;
        protected Localize CreatedBy;
        protected Localize OnLabel;
        protected Localize CreatedDate;

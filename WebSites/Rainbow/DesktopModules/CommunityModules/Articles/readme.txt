...
This module renders a list of Articles.
...
Ver. 1.2 - Chris Farrell-Chris@cftechconsulting.com.  5/24/2004
Ver. 1.5 - Manu. 6/14/2005
			Added Inline variant
			Added roles the can view expired items
			Added abstract rich editor support

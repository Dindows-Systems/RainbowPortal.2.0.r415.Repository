...
- Tested with Rainbow version 1.3.0.1756a - 26/12/2003
...
Sample from contacts:
		...
		public override System.Text.StringBuilder SearchSqlSelect(int portalID, int userID, string searchString, string searchField, System.Text.StringBuilder select)
		{
			...
			Rainbow.Framework.Helpers.SearchDefinition s = new Rainbow.Framework.Helpers.SearchDefinition("rb_Contacts", "Role", "Name", "CreatedByUser", "CreatedDate", searchField);

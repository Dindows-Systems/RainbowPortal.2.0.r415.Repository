        ...
        <td>
                    ...
                    <itemtemplate>
                        <div class="BlogTitle">
                            <rbfwebui:hyperlink id="editLink" runat="server" imageurl='<%# CurrentTheme.GetImage("Buttons_Edit", "Edit.gif").ImageUrl %>'
                                navigateurl='<%# Rainbow.Framework.HttpUrlBuilder.BuildUrl("~/DesktopModules/CommunityModules/Blog/BlogEdit.aspx",PageID,"ItemID=" + DataBinder.Eval(Container.DataItem,"ItemID") + "&amp;mid=" + ModuleID )%>'
                                text="Edit" textkey="EDIT" visible="<%# IsEditable %>">
                            </rbfwebui:hyperlink>
                            <rbfwebui:hyperlink id="Title" runat="server" cssclass="BlogTitle" navigateurl='<%# Rainbow.Framework.HttpUrlBuilder.BuildUrl("~/DesktopModules/CommunityModules/Blog/BlogView.aspx",PageID,"ItemID=" + DataBinder.Eval(Container.DataItem,"ItemID") + "&amp;mid=" + ModuleID )%>'
                        ...
                        <div class="BlogFooter">
                            <rbfwebui:hyperlink id="Hyperlink1" runat="server" navigateurl='<%# Rainbow.Framework.HttpUrlBuilder.BuildUrl("~/DesktopModules/CommunityModules/Blog/BlogView.aspx",PageID,"ItemID=" + DataBinder.Eval(Container.DataItem,"ItemID") + "&amp;mid=" + ModuleID )%>'
                            ...
                            <rbfwebui:hyperlink id="Hyperlink2" runat="server" navigateurl='<%# Rainbow.Framework.HttpUrlBuilder.BuildUrl("~/DesktopModules/CommunityModules/Blog/BlogView.aspx",PageID,"ItemID=" + DataBinder.Eval(Container.DataItem,"ItemID") + "&amp;mid=" + ModuleID )%>'
            ...
            <div class="div_blog_stats">
                ...
                <asp:repeater id="dlArchive" runat="server" enableviewstate="False">
                    ...
                    <itemtemplate>
                        <li>
                            <rbfwebui:hyperlink id="Hyperlink4" runat="server" navigateurl='<%# Rainbow.Framework.HttpUrlBuilder.BuildUrl("~/DesktopModules/CommunityModules/Blog/ArchiveView.aspx",PageID,

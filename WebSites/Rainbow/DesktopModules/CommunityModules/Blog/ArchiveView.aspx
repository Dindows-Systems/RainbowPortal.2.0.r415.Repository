                            ...
                            <itemtemplate>
                                <div class="div_blog_archive_row">
                                    <table border="0">
                                        <tr>
                                            <td width="99%">
                                                <rbfwebui:HyperLink id="Title" runat="server" navigateurl='<%# Rainbow.Framework.HttpUrlBuilder.BuildUrl("~/DesktopModules/CommunityModules/Blog/BlogView.aspx",PageID,"ItemID=" + DataBinder.Eval(Container.DataItem,"ItemID") + "&amp;mid=" + ModuleID )%>'

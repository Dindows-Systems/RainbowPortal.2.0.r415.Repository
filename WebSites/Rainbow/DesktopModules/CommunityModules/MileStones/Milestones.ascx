<%@ control autoeventwireup="false" codefile="Milestones.ascx.cs" inherits="Rainbow.Content.Web.Modules.Milestones"
    language="c#" %>
        ...
        <rbfwebui:templatecolumn>
            <itemtemplate>
                <rbfwebui:HyperLink ID="editLink" TextKey="EDIT" Text="Edit" ImageUrl='<%# CurrentTheme.GetImage("Buttons_Edit", "Edit.gif").ImageUrl %>'
                    NavigateUrl='<%# Rainbow.Framework.HttpUrlBuilder.BuildUrl("~/DesktopModules/CommunityModules/MileStones/MilestonesEdit.aspx", "ItemID=" + DataBinder.Eval(Container.DataItem,"ItemID") + "&Mid=" + ModuleID) %>'

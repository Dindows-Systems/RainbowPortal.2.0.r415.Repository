<%@ Control AutoEventWireup="false" CodeFile="Roles.ascx.cs" Inherits="Rainbow.Content.Web.Modules.Roles"
    ...
    <tr>
        <td>
            ...
            <rbfwebui:LinkButton ID="AddRoleBtn" runat="server" CssClass="CommandButton" Text="Add New Role"
                TextKey="AM_ADDROLE" OnClick="AddRole_Click" />
            <asp:RequiredFieldValidator ID="txtNewRoleValidator" runat="server" ControlToValidate="txtNewRole" ErrorMessage="Role Name can't be empty" />
        </td>
    </tr>
    <tr>
        <td class="Error">

<%@ control autoeventwireup="false" inherits="Rainbow.Content.Web.Modules.AddModule.Viewer"
    language="c#" codefile="Viewer.ascx.cs" %>
<table align="center" border="0">
    <tr>
        <td valign="top">
            <rbfwebui:localize id="moduleNameLabel" runat="server" text="<%$ Resources:Rainbow, AM_MODULETYPE %>">
    ...
    <tr>
        <td valign="top">
            <rbfwebui:localize id="moduleLocationLabel" runat="server" text="<%$ Resources:Rainbow, AM_MODULELOCATION %>">
            </rbfwebui:localize></td>
        <td valign="top">
    ...
    <tr>
        <td valign="top">
            <rbfwebui:localize id="moduleVisibleLabel" runat="server" text="<%$ Resources:Rainbow, AM_MODULEVISIBLETO %>">
    ...
    <tr>
        <td valign="top">
            <rbfwebui:localize id="moduleTitleLabel" runat="server" text="<%$ Resources:Rainbow, AM_MODULENAME %>">
            </rbfwebui:localize></td>
        <td valign="top">
...
-->
    <rbfwebui:localize id="moduleError" runat="server" enableviewstate="False" text="<%$ Resources:Rainbow, AM_MODULENAME %>"
        visible="False">

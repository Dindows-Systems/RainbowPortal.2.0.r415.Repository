...
CREATE PROCEDURE rb_GetFAQs_Summary
(
    @ModuleID   int
)
AS
SELECT ItemID,Question As ItemDesc  FROM rb_FAQs WHERE ModuleID = @ModuleID
GO
/***************************************************************************************/
...
CREATE PROCEDURE rb_FAQs_CopyItem
(
...
CREATE PROCEDURE rb_FAQs_MoveItem
(
    @ItemID         int,
    @TargetModuleID int
)
...
CREATE PROCEDURE rb_FAQs_CopyAll
(
...
SELECT
	...
	Answer
FROM
    rb_FAQs WHERE ModuleID = @SourceModuleID
GO
/***************************************************************************************/
/*
SUGGESTIONS:

<%@ control autoeventwireup="false" codefile="Recycler.ascx.cs" inherits="Rainbow.Content.Web.Modules.Recycler"
    language="c#" %>
<asp:datagrid id="DataGrid1" runat="server" allowsorting="true" alternatingitemstyle-backcolor="#fff5c9"
    ...
    <columns>
        <rbfwebui:templatecolumn sortexpression="ModuleTitle">
            ...
            <itemtemplate>
                <rbfwebui:HyperLink ID="Hyperlink2" NavigateUrl='<%# Rainbow.Framework.HttpUrlBuilder.BuildUrl("~/DesktopModules/CoreModules/Recycler/view.aspx","mid=" + DataBinder.Eval(Container.DataItem,"ModuleID")) %>'
                    runat="server">

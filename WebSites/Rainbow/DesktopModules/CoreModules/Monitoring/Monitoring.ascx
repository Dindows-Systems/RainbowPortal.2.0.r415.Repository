<%@ control autoeventwireup="false" codefile="Monitoring.ascx.cs" inherits="Rainbow.Content.Web.Modules.Monitoring"
    language="c#" %>
    ...
    <table align="center" border="0" cellpadding="2" cellspacing="2" width="100%">
        <tr valign="top">
            ...
            <td align="left" class="SubHead" height="19" rowspan="5" valign="top">
                ...
                <asp:checkbox id="CheckBoxIncludeAdminUser" runat="server" /><rbfwebui:label id="Label5"
                    runat="server">Include admin user</rbfwebui:label><br>

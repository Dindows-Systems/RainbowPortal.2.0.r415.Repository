<%@ control autoeventwireup="false" inherits="Rainbow.Content.Web.Modules.SendNewsletter"
    language="c#" codefile="Newsletter.ascx.cs" targetschema="http://schemas.microsoft.com/intellisense/ie5" %>
<table width="100%">
    <tr>
        <td colspan="5">

<%@ Control AutoEventWireup="false" Inherits="Rainbow.Content.Web.Modules.Users"
    Language="c#" CodeFile="Users.ascx.cs" %>
                                ...
                                <asp:GridView ID="allUsers" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Commands">
                                            ...
                                            <ItemTemplate>
                                                <rbfwebui:LinkButton ID="EditBtn" runat="server" CommandArgument='<%# Eval("Email") %>'

...
<table cellspacing="0" cellpadding="0" width="100%" bgcolor="#ffffff" border="0" runat="server">
    <tbody>
        <tr>
            <td align="center">
                <br />
                <%if (GetMetadata("PreviousItemID") != null) {%><a href='<%# Rainbow.Framework.HttpUrlBuilder.BuildUrl("~/DesktopModules/Pictures/PictureView.aspx","ItemID=" + GetMetadata("PreviousItemID") + "&amp;mid=" + GetMetadata("ModuleID") + "&amp;wversion=" + GetMetadata("WVersion"))%>' runat="server"><img src='<%# Rainbow.Framework.HttpUrlBuilder.BuildUrl("~/Design/PictureLayouts/previous.gif")%>' border="0" runat="server" /> </a><%}%><%if (GetMetadata("NextItemID") != null) {%><a href='<%# Rainbow.Framework.HttpUrlBuilder.BuildUrl("~/DesktopModules/Pictures/PictureView.aspx","ItemID=" + GetMetadata("NextItemID") + "&amp;mid=" + GetMetadata("ModuleID") + "&amp;wversion=" + GetMetadata("WVersion"))%>' runat="server"><img src='<%# Rainbow.Framework.HttpUrlBuilder.BuildUrl("~/Design/PictureLayouts/next.gif")%>' border="0" runat="server" /> </a><%}%></td>
        </tr>
        <tr>
            <td align="center">

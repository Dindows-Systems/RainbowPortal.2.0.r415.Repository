...
<rbfwebui:DESKTOPPANES id="ThreePanes" height="100%" ShowLogon="False" ShowLastSeparator="False" ShowFirstSeparator="False" Cellpadding="0" cellspacing="0" runat="server">
    <LEFTPANETEMPLATE>
        <rbfwebui:MENUNAVIGATION id="NavigationMenu" runat="server" Height="20" TopPaddng="1" StartTop="0" StartLeft="0" Width="185px" BorderWidth="0" ImagesPath="/design/Themes/default/img" Bind="BindOptionCurrentChilds" AutoShopDetect="True" AutoBind="True" LeftPaddng="5" Horizontal="False" visible="True">
